...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-36907"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-v1",
      "problem_contract_sha256": "207ca85688a75ef57a2227b45cd7fe29fb6f5690a32655056c0e6b2d27883277",
      "problem_id": "problem:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968",
      "route_id": "route:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-source-fidelity-01",
      "graph_id": "graph:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture A triangle-free graph with maximum degree $\\Delta$ has chromatic number at most $\\ceil{\\frac{\\Delta}{2}}+2$."
          },
          "statement_sha256": "cd4a15a99b085c3676b82c17a6e62ee7b4b92e8a72fc8ffa13ac66ba5da505f8"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-root",
      "route_id": "route:um-opg-36907-bounding-the-chromatic-number-of-trian-3d200968-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-36907-5eafe7ab7513",
        "url": "https://www.unsolvedmath.com/problems/OPG-36907"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
